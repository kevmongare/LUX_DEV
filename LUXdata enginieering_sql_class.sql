...
SELECT*FROM courses.coursesinfo WHERE course_name  like '%Science'; ---WE LOOK FOR PARTENS IN THE VALUES IN OUR DATABASE USING THE %N WHERE IT LOOKS FOR NAMES THAT END WITH THE LETTER/STRING OR N% FOR THOSE THAT START WITH THE DETAILS
SELECT AVG(grade) from students.studentinfo; --WE ARE WORKING ON HOW TO HAVE AN AVARAGE
